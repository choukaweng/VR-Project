...
public class Cube : MonoBehaviour {
	...
	//Major elements of mesh = Vertices, Triangles, Normals, UV
	private Mesh mesh;
...
//		int[] triangles = new int[quads * 6];
		...
		int[] trianglesY = new int[(xSize * ySize) * 12];
...
//		}
//
//		t = CreateTopFace (triangles, t, ring);v++;
